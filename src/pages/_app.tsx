  ...
  return (
    <div className={`${inter.variable} font-sans`}>
      <Head>
        ...
        <meta property="og:image" content="https://www.fusalabs.com/img/logofusalabs.png.png" />
        <meta property="og:image:secure_url" content="https://www.fusalabs.com/img/logofusalabs.png.png" />
        ...
        <meta name="twitter:image" content="https://www.fusalabs.com/img/logofusalabs.png.png" />
      </Head>
      <Component {...pageProps} />
    </div>
  );
