...
export const ServiceCard = ({
  ...
  return (
    ...
    <div className="relative z-10">
      <h3 className="text-2xl md:text-5xl font-bold mb-8 group-hover:translate-x-2 transition-transform duration-500 ease-in-out leading-tight font-conthrax text-fusa-white break-words tracking-tight">
        {title}
      </h3>
